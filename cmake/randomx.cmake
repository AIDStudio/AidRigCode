if (WITH_RANDOMX)
    ...
    if (WITH_SSE4_1)
        ...
        if (CMAKE_C_COMPILER_ID MATCHES GNU OR CMAKE_C_COMPILER_ID MATCHES Clang)
            set_source_files_properties(src/crypto/randomx/blake2/blake2b_sse41.c PROPERTIES COMPILE_FLAGS "-O3 -fno-fast-math -msse4.1")
        endif()
    endif()
    ...
    if (WITH_AVX2)
        ...
        if (CMAKE_C_COMPILER_ID MATCHES GNU OR CMAKE_C_COMPILER_ID MATCHES Clang)
            set_source_files_properties(src/crypto/randomx/blake2/avx2/blake2b_avx2.c PROPERTIES COMPILE_FLAGS "-O3 -fno-fast-math -mavx2")
        endif()
    endif()
